...
使用微信支付的前提必开通微信商户号，支付的钱最终都会到商户号里（一般由公司财务开通）。
开发微信支付的过程中大大小小坑还是踩了不少，终于做完了，整理下开发流程。

支付方式一览（开发前需在商户平台开通）：

- 付款码支付：线下使用，用户展示二维码支付，商家扫码
- JSAPI 支付：微信内网页支付，需要开通微信服务号
- 小程序支付：在小程序中支付，需要开通小程序
- Native 支付：PC 端网页支付，商家展示二维码，用户扫码支付
- APP 支付：在 APP 中调取微信支付
- H5 支付：在手机浏览器（出微信内网爷）中网页支付
- 刷脸支付：线下使用，商家通过刷脸设备扫用户的脸进行支付（同付款码类似，一个扫码，一个扫脸）
