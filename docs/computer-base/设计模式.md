...
与其说是一篇文章，其实更像是一篇总结型的学习笔记。

<!--
![b9620655e14c0679fb7976cb6e01c3c.png](https://i.loli.net/2021/04/07/kPqO3IpmGKY8zA4.png) -->
...
涉及到兼容性，参数支持多个格式、环境等等.. 对外暴露统一的api
...
- [javascript设计模式之解释器模式详解](https://www.jb51.net/article/50680.htm)
...
参考链接：[JavaScript中介者模式](https://segmentfault.com/a/1190000020075738)
...
- [W3CSchool](https://www.w3cschool.cn/zobyhd/iqdu9ozt.html)
